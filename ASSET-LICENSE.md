...
The HTML, CSS and JavaScript source code in this repository is licensed under the MIT Licence as described in `LICENSE`.

Game artwork, screenshots, video, music, audio, logos, trademarks and written content are not included in the MIT Licence.
